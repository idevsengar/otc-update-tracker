// === Column headers as they appear in your JSON ===
const COLS = [
  "SR No",
  "District Number",
  "Customer Name",
...
async function loadData() {
  // Load JSON from repo (cache-bust)
  const res = await fetch("data/updates.json?_=" + Date.now());
...
function populateDropdowns() {
  ...
  // District can be numeric, CSV list "216, 217, 286", or names like "Atlantic Coast Area"
...
function applyFilters() {
  ...
  // Sort: newest date first if present
